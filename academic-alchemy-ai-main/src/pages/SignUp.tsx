...
const SignUp = () => {
  ...
  const handleSignUp = async () => {
    ...
    setLoading(true);
    try {
      await login(email, password, name, true);
      navigate("/onboarding");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 gradient-mesh-bg">
      <motion.div
      ...
      >
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground">Start studying smarter with AI</p>
        </div>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              disabled={loading}
              className="pl-10 bg-muted/50 border-white/5 h-12 rounded-xl" 
            />
          </div>
          <div className="relative">
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 rounded-xl bg-muted/30 border-white/5"
